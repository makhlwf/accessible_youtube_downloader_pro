...
def get_playlist(playlist_url, basic=False, gdata=False, size=False, callback=None):
...
class Playlist(object):
    ...
    def _fetch_basic(self):
        query = {"part": "snippet, contentDetails", "id": self.plid}
...
def get_playlist2(playlist_url, basic=False, gdata=False, size=False, callback=None):
